...
export const Hero: React.FC<HeroProps> = ({ onEmergencyClick }) => {
  return (
    <div className="bg-zinc-900 text-white py-10 sm:py-14 px-4 rounded-b-3xl sm:rounded-b-[3rem] shadow-2xl relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        <div className="inline-block mb-3 px-3 py-1 rounded-full bg-indigo-900/50 border border-indigo-700 text-indigo-300 text-xs font-semibold tracking-wide uppercase">
