...
export const UserProfile: React.FC<UserProfileProps> = ({ user, onSave, onBack }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-3 sm:px-4 py-6 sm:py-8 animate-fade-in-up">
      <button 
        onClick={onBack}
        className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 font-medium mb-4 sm:mb-6 transition-colors text-sm sm:text-base"
      >
      ...
      <div className="bg-white dark:bg-zinc-800 rounded-2xl sm:rounded-3xl shadow-xl shadow-zinc-200/50 dark:shadow-none border border-zinc-100 dark:border-zinc-700 overflow-hidden transition-colors duration-300">
        ...
        <form onSubmit={handleSubmit} className="p-5 sm:p-8">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-end gap-3 sm:gap-4">
            ...
            <button
              type="submit"
              className="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-xl flex items-center justify-center gap-2 transition-all hover:shadow-lg shadow-indigo-500/30 text-sm sm:text-base"
            >
