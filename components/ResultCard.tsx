...
export const ResultCard: React.FC<ResultCardProps> = ({ chunk, onContact }) => {
  ...
  return (
    <div className="bg-white dark:bg-zinc-800 rounded-xl p-3 sm:p-4 shadow-sm border border-zinc-200 dark:border-zinc-700 hover:shadow-md hover:border-indigo-200 dark:hover:border-indigo-700 transition-all flex flex-col gap-2.5 sm:gap-3 group">
      <div className="flex justify-between items-start">
        <div className="flex gap-2.5 sm:gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] sm:text-xs text-zinc-500 dark:text-zinc-400 mt-0.5 sm:mt-1">Local verificado</p>
          </div>
        </div>
      </div>
