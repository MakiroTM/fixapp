...
export const BottomNav: React.FC<BottomNavProps> = ({ currentView, onNavigate }) => {
  ...
  return (
    ...
    >
      <div className="bg-zinc-900/90 backdrop-blur-xl border border-zinc-800/60 shadow-[0_8px_32px_rgba(59,130,246,0.15)] rounded-3xl mx-auto max-w-md pointer-events-auto flex items-center justify-between px-3 py-2">
        {navItems.map((item) => {
            ...
            >
              ...
              <Icon 
                ...
                className={`relative z-10 transition-colors duration-200 ${
                  isActive ? 'text-blue-600' : 'text-zinc-500 hover:text-zinc-300:text-zinc-300'
                }`}
